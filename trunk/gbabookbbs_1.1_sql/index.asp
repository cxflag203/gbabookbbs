...
Sub Main()
	If RQ.UserID > 0  Then
		...
		RQ.Execute("UPDATE "& TablePre &"members SET logintime = GETDATE()"& strSQL &" WHERE uid = "& RQ.UserID)
		Call closeDatabase()
	End If
%>
<html>
...
<div class="mainbg">
  <div class="leftstuff">
	...
	<div class="memberzone">
	  <% If RQ.UserID > 0 Then %>
      <span>您好，<%= RQ.UserName %> [<a href="login.asp?action=clearcookies" class="mcplink" target="_top";>退出</a>]</span>
