...
Sub UploadAttach()
	...
	For Each Files In Upload.Files(-1)
		...
		If File.SaveToFile("./attachments/"& SavePath) Then
			...
			RQ.Execute("INSERT INTO "& TablePre &"attachments (uid, filename, filetype, filesize, savepath, ifimage) VALUES ("& RQ.UserID &", N'"& File.LocalName &"', '"& File.Mime &"', "& File.Size &", '"& SavePath &"', "& IfImage &")")
