...
Sub SaveTopic()
	...
	If RQ.Get_Forum_Settings(NewForumID, 13) = 1 And TypeID = 0 Then
...
<% 
	If RQ.IsModerator And RQ.AllowManageTopic = 1 And Page = 1 Then
		...
		If PostListArray(1, 0) > 0 Then
			...
			Response.Write "<a href=""pm.asp?action=send&u="& PostListArray(2, 0) &""" class=""bluelink"" onclick=""return shows(this.href);"">传呼</a>"
...
<%
	...
	'显示回复
	If UBound(PostListArray, 2) > 0 Then
		...
		For i = ArrayPosition To CountArray
			...
			If RQ.IsModerator Then 
				Response.Write "&nbsp;&nbsp;<a href=""pm.asp?action=send&u="& PostListArray(2, i) &""" onclick=""return shows(this.href);"" class=""bluelink"">传呼</a>"
