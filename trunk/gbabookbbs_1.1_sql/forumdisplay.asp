...
'========================================================
Sub Show_Topics()
	Dim RecordCount, PageCount, Cmd, TopicListArray, CountArray
	...
	With Cmd
		...
		.Parameters.Item("@pagesize").Value = IntCode(RQ.Topic_Settings(2))
	...
	If IsArray(TopicListArray) Then
		...
		For i = 0 To CountArray
			...
			Response.Write "<a href=""viewtopic.asp?fid="& RQ.ForumID &"&tid="& TopicListArray(0, i) &""" title='【"& TopicListArray(8, i) &" "& TopicListArray(5, i) &"】'>"& TopicListArray(6, i) &" ("& TopicListArray(11, i) &"/"& TopicListArray(10, i) &")</a><br />"
		Next
