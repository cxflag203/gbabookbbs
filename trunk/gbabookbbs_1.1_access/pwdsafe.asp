...
Sub Chk_GuestQuestion()
	...
	UserInfo = RQ.Query("SELECT secques FROM "& TablePre &"members WHERE username = '"& UserName &"'")
...
Sub UpdatePassword()
	...
	UserInfo = RQ.Query("SELECT uid, secques FROM "& TablePre &"members WHERE username = '"& UserName &"'")
