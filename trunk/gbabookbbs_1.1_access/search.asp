...
Sub Search()
	...
	If blnUpdateCache Then
		...
		Else
			RQ.Execute("INSERT INTO "& TablePre &"searchindex (keyword, searchtype, recordcount, tid, expirytime) VALUES ('"& Keyword &"', "& lngSearchType &", "& RecordCount &", '"& TopicID &"', #"& DATEADD("n", 5, Now()) &"#)")
...
Function Get_UserID(Keyword)
	...
	Else
		RQ.Execute("INSERT INTO "& TablePre &"searchindex (keyword, searchtype, recordcount, tid, expirytime) VALUES ('"& Keyword &"', 1, 0, '0', #"& DATEADD("n", 5, Now()) &"#)")
		str = "0"
