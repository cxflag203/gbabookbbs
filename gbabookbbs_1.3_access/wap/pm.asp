...
Sub PostNewPm()
	...
	If UCase(UserInfo(1, 0)) = "{ALL}" Or InStr(","& UserInfo(1, 0) &",", ","& RQ.UserName &",") > 0 Then
		Call WapMessage(UserName &"无法接收您的传呼。", "")
	End If
...
Sub ShowFavor()
	...
	If RecordCount > 0 Then
		...
		strSQL = "SELECT TOP "& RQ.Wap_Settings(3) &" pmid, message, posttime FROM "& TablePre &"pms WHERE uid = "& RQ.UserID
		If Page > 1 Then
