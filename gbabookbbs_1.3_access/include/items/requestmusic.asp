...
If Action = "useitem" Then
	...
	ItemMessage = URL &"_____SPLIT_____"& Name &"_____SPLIT_____"& Sendto &"_____SPLIT_____"& Message

	'保存
	RQ.Execute("INSERT INTO "& TablePre &"itemmessages (itemid, uid, username, message) VALUES ("& ItemID &", "& RQ.UserID &", '"& RQ.UserName &"', '"& ItemMessage &"')")
	...
	For i = 0 To UBound(MessageListArray, 2)
		TEMP = Split(MessageListArray(1, i), "_____SPLIT_____")
